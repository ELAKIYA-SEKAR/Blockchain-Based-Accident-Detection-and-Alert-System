...
// Capture the HTML output of diffDB.php
ob_start();
include('diffDB.php');
...
<head>
    ...
    <title>Compare Blockchain Blocks</title>
...
<body>
    <div class="header-navbar">
        ...
        <ul class="top-menu">
            ...
            <li><a class="active" class="side-menu" href="diffBlockchain.php"><img src="images/diff.png">Diff DB</a></li>
    ...
    <div class="form-module form-module-large">
        <div class="content">
            <h2 class="headings">Difference in DB</h2>
            <?php echo $diff_output; ?>
        </div>
    </div>
